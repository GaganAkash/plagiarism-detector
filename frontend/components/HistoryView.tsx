    ...
    <div className="card glass">
      ...
      <style jsx>{`
        ...
        .hist-item {
          ...
          background: rgba(47,174,115,0.05);
          border: 1px solid rgba(47,174,115,0.18);
          color: #e4f6e9;
          border-radius: 14px;
        ...
        .hist-item:hover { background: rgba(47,174,115,0.1); transform: translateY(-1px); border-color: rgba(47,174,115,0.4); box-shadow: 0 0 16px rgba(47,174,115,0.2); }
        .hist-item.sel { border-color: rgba(47,174,115,0.8); background: rgba(47,174,115,0.14); box-shadow: 0 0 18px rgba(47,174,115,0.3); }
        .h-id { color: #2fae73; font-weight: 600; text-shadow: 0 0 8px rgba(47,174,115,0.6); }
        .h-center { display: flex; flex-direction: column; align-items: flex-start; gap: 0.15rem; }
        .h-meta { font-size: 0.75rem; color: #93bd9f; }
        .h-meta i { font-style: normal; color: #a6e08e; }
        .viewing { margin-left: auto; font-size: 0.7rem; color: #3fe0a4; }
        .empty { text-align: center; padding: 2rem 1rem; color: #93bd9f; }
        .empty p { margin: 0.5rem 0 0; font-size: 0.88rem; }
        .e-icon { font-size: 1.8rem; }
        .pill { font-size: 0.72rem; padding: 0.15rem 0.5rem; border-radius: 999px; border: 1px solid rgba(47,174,115,0.35); }
