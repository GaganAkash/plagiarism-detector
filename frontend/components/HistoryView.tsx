  ...
  return (
    <div className="card glass">
      ...
      <style jsx>{`
        ...
        .hist-item:hover { background: rgba(0,229,255,0.1); transform: translateY(-1px); border-color: rgba(0,229,255,0.4); box-shadow: 0 0 16px rgba(0,229,255,0.2); }
        .hist-item.sel { border-color: rgba(0,229,255,0.8); background: rgba(0,229,255,0.14); box-shadow: 0 0 18px rgba(0,229,255,0.3); }
        .h-id { color: #00e5ff; font-weight: 600; text-shadow: 0 0 8px rgba(0,229,255,0.6); }
        .h-center { display: flex; flex-direction: column; align-items: flex-start; gap: 0.15rem; }
        .h-meta { font-size: 0.75rem; color: #6fa6b8; }
        .h-meta i { font-style: normal; color: #8fe8ff; }
        .viewing { margin-left: auto; font-size: 0.7rem; color: #3fe0a4; }
        .empty { text-align: center; padding: 2rem 1rem; color: #6fa6b8; }
        .empty p { margin: 0.5rem 0 0; font-size: 0.88rem; }
        .e-icon { font-size: 1.8rem; }
        .pill { font-size: 0.72rem; padding: 0.15rem 0.5rem; border-radius: 999px; border: 1px solid rgba(0,229,255,0.35); }
