  ...
  return (
    <div className="card glass">
      ...
      <style jsx>{`
        ...
        .dropzone:hover { border-color: rgba(0,229,255,0.7); background: rgba(0,229,255,0.08); }
        .dropzone.dragging { border-color: #00ffc8; background: rgba(0,255,200,0.14); box-shadow: 0 0 22px rgba(0,229,255,0.35); transform: scale(1.01); }
        .dz-icon { font-size: 2rem; display: block; margin-bottom: 0.5rem; color: #8fe8ff; }
        .dz-title { font-size: 1.02rem; font-weight: 600; }
        .dz-sub { font-size: 0.82rem; color: #6fa6b8; margin-top: 0.2rem; }
        ...
        .f-sub { font-size: 0.8rem; color: #6fa6b8; }
        .f-x { margin-left: auto; cursor: pointer; color: #6fa6b8; padding: 0.3rem 0.6rem; border-radius: 8px; }
